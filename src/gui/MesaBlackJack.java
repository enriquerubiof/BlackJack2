...
public class MesaBlackJack extends JFrame {
	...
	private ArrayList<JLabel> cartasRival;
	/**
	...
	public MesaBlackJack()
	{
		...
		cartasRival = new ArrayList<JLabel>();
		seguir = true;
		setType(Type.POPUP);
		setResizable(false);
		...
		contentPane.setLayout(new MigLayout("", "[25.00][150][130px][5][130px][5][130px][5][130px][5][130px][5][130px][5][130px][5][130px][25]", "[grow][210][39.00][210][grow]"));
		...
		contentPane.add(lblTuCarta8, "cell 16 1");
		...
		btnPasar.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				cartasPuls.get(momento - 2).setEnabled(false);
				seguir = false;
				finalizarTuTurno();
				turnoBanca();
		...
		lblRvCarta1.setSize(new Dimension(130, 182));
		lblRvCarta1.setPreferredSize(new Dimension(130, 182));
		...
		lblRvCarta2.setSize(new Dimension(130, 182));
		lblRvCarta2.setPreferredSize(new Dimension(130, 182));
		...
		lblRvCarta3.setSize(new Dimension(130, 182));
		lblRvCarta3.setPreferredSize(new Dimension(130, 182));
		...
		contentPane.add(lblRvCarta8, "cell 16 3");
	}

	protected void voltearCarta(MouseEvent e)
	{
		try {
			this.partida.jugarCarta(this.partida.getJugadores().get(0));
	...
	{
		cartasPuls.get(momento - 1).setEnabled(false);
		seguir = false;
	...
	protected void activarTablero()
	{
		...
		cartasRival.add(this.lblRvCarta2);
		cartasRival.add(this.lblRvCarta3);
		cartasRival.add(this.lblRvCarta4);
		cartasRival.add(this.lblRvCarta5);
		cartasRival.add(this.lblRvCarta6);
		cartasRival.add(this.lblRvCarta7);
		cartasRival.add(this.lblRvCarta8);
		...
		this.lblTuCarta1.setIcon(new ImageIcon(MesaBlackJack.class.getResource("/imagenes/cartasPoker/" + 
				this.partida.getJugadores().get(0).getBaraja().get(this.partida.getJugadores().get(0).getBaraja().size() - 1) + ".png")));
		
		this.lblTuCarta2.setIcon(new ImageIcon(MesaBlackJack.class.getResource("/imagenes/reverso5.jpg")));
		
		
		this.lblRvCarta1.setIcon(new ImageIcon(MesaBlackJack.class.getResource("/imagenes/cartasPoker/" + 
				this.partida.getBanca().getBaraja().get(this.partida.getBanca().getBaraja().size() - 1) + ".png")));
		
		this.lblRvCarta2.setIcon(new ImageIcon(MesaBlackJack.class.getResource("/imagenes/reverso5.jpg")));
